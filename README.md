...
* RobinHood is now API 15+ only.
* I will also be implementing RxJava, Material design and a few other things into this app as well.
There will be *no upgrade path* as RobinHood is mean to act as a starting point for Android Applications.

# RobinHood App

[![Build Status](https://travis-ci.org/AndroidBootstrap/com-campfiresolutions-robinhood.svg?branch=master)](https://travis-ci.org/AndroidBootstrap/com-campfiresolutions-robinhood)

This repository contains the source code for the [RobinHood](http://www.androidbootstrap.com/)
Android app available from [Google Play](https://play.google.com/store/apps/details?id=com.campfiresolutions.robinhood).

Please see the [issues](https://github.com.campfiresolutions.robinhood/com-campfiresolutions-robinhood/issues) section
to report any bugs or feature requests and to see the list of known issues.

Have a questions about RobinHood? Ask away on the [com-campfiresolutions-robinhood discussion forum](https://groups.google.com/forum/#!forum/com-campfiresolutions-robinhood).

<a href="https://play.google.com/store/apps/details?id=com.campfiresolutions.robinhood" alt="Download from Google Play">
...
code for the app will change:
  ...
  - From: __com.campfiresolutions.robinhood__
  - To: __com/notify/app/mobile__

At that point all the source files that were located in ____com.campfiresolutions.robinhood__ will be moved to the
new folder __com/notify/app/mobile__.

All import statments that reference the old resources (__R.com.campfiresolutions.robinhood.R__) will now be renamed
...
signed with a different key.  Manually uninstall RobinHood from your device and
...
RobinHood is a result of a template project I've developed over the years as well as
...
RobinHood is built on the awesome [Parse.com API](http://www.parse.com/)
...
## Contributors
Thank you to all the [contributors](http://www.github.com.campfiresolutions.robinhood/com-campfiresolutions-robinhood/contributors) on
...
[pull requests](https://github.com.campfiresolutions.robinhood/com-campfiresolutions-robinhood/pulls).
