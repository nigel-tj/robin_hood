...
public final class Constants {
    ...
    public static final class Auth {
         ...
         * Account type id
         */
        public static final String BOOTSTRAP_ACCOUNT_TYPE = "com.campfiresolutions.robinhood";

        /**
         * Account name
         */
        public static final String BOOTSTRAP_ACCOUNT_NAME = "RobinHood";

        /**
         * Provider id
         */
        public static final String BOOTSTRAP_PROVIDER_AUTHORITY = "com.campfiresolutions.robinhood.sync";
    ...
    public static final class Intent {
         ...
         */
        public static final String INTENT_PREFIX = "com.campfiresolutions.robinhood.";
